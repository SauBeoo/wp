 ...
 * @since 3.12.1
 */
final class WC_CASSO_ACB_Blocks_Support extends AbstractPaymentMethodType {
	/**
	 * Name of the payment method.
	 *
	 * @var string
	 */
	protected $name = 'casso_up_acb';
	protected $bank_name = 'ACB';
	...
	public function is_active() {
		...
		return $payment_gateways['casso_up_acb']->is_available();
	}
	...
	public function get_payment_method_script_handles() {
		...
		wp_register_script(
			'wc-casso_up_acb-blocks-integration',
			CASSO_URL . '/assets/js/acb.js',
			$dependencies,
			$version,
			true
		);
		wp_set_script_translations(
			'wc-casso_up_acb-blocks-integration',
			'woocommerce-gateway-casso_up_acb'
		);
		return [ 'wc-casso_up_acb-blocks-integration' ];
	}
	...
	public function get_payment_method_data() {
		...
		return [
			...
			'logo_url'    => CASSO_URL . '/assets/acb.png'
		];
	}
	...
	public function get_supported_features() {
		...
		return $payment_gateways['casso_up_acb']->supports;
	}
