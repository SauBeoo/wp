 ...
 * @since 3.12.1
 */
final class WC_CASSO_VPBank_Blocks_Support extends AbstractPaymentMethodType {
	/**
	 * Name of the payment method.
	 *
	 * @var string
	 */
	protected $name = 'casso_up_vpbank';
	protected $bank_name = 'VPBank';
	...
	public function is_active() {
		...
		return $payment_gateways['casso_up_vpbank']->is_available();
	}
	...
	public function get_payment_method_script_handles() {
		...
		wp_register_script(
			'wc-casso_up_vpbank-blocks-integration',
			CASSO_URL . '/assets/js/vpbank.js',
			$dependencies,
			$version,
			true
		);
		wp_set_script_translations(
			'wc-casso_up_vpbank-blocks-integration',
			'woocommerce-gateway-casso_up_vpbank'
		);
		return [ 'wc-casso_up_vpbank-blocks-integration' ];
	}
	...
	public function get_payment_method_data() {
		...
		return [
			...
			'logo_url'    => CASSO_URL . '/assets/vpbank.png'
		];
	}
	...
	public function get_supported_features() {
		...
		return $payment_gateways['casso_up_vpbank']->supports;
	}
