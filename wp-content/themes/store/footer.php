                    ...
                    <div class="footerMainAddress" >
                        ...
                        <ul>
                            <li class="contact-1">
                                ...
                                <span>62/7 Thạch Thị Thanh, Phường Tân Định, Quận 1</span>
                            </li>
                            <li class="contact-2"><i class="lni lni-phone"></i> <span>0909871740</span></li>
                            <li class="contact-3">
                                <i class="lni lni-envelope"></i>
                                <span>lamluyvietnam@gmail.com</span>
                            </li>
                            <li class="contact-4">
                                <i class="lni lni-timer"></i>
                                <span>8am - 9:30pm hằng ngày</span>
                            </li>
                        </ul>
                        ...
                        <div class="logo-footer" >
                            ...
                            <a href="http://online.gov.vn/Home/WebDetails/83273" target="_blank"
                    ...
                    <div class="footerMainList menuclickmb" >
                        ...
                        <div class="FooterMainListToggle" >
                            <ul>
                                ...
                                <li class="item">
                                    <a href="/pages/chinh-sach-bao-mat" title="Chính sách bảo hành, đổi trả hành">Chính
                                        sách bảo hành, đổi trả hành</a>
                                </li>

                                <li class="item">
                                    <a href="/pages/chinh-sach-bao-mat-thong-tin"
                                       title="Chính sách bảo mật thông tin cá nhân">Chính sách bảo mật thông tin cá
                                        nhân</a>
                                </li>

                                <li class="item">
                                    <a href="/pages/dieu-khoan-dich-vu" title="Chính sách giao hàng">Chính sách giao
                                        hàng</a>
                                </li>

                                <li class="item">
                                    <a href="/pages/chinh-sach-thanh-toan-va-huong-dan-mua-hang"
                                       title="Hướng dẫn mua hàng">Hướng dẫn mua hàng</a>
                                </li>

                                <li class="item">
                                    <a href="/pages/hinh-thuc-thanh-toan" title="Hình thức thanh toán">Hình thức thanh
                                        toán</a>
                                </li>
                    ...
                    <div class="footerMainList  menuclickmb" >
                        ...
                        <div class="FooterMainListToggle" >
                            <ul>
                                ...
                                <li class="item">
                                    <a href="/blogs/thoi-trang-noi-y" title="Thời trang nội y">Thời trang nội y</a>
                                </li>

                                <li class="item">
                                    <a href="/blogs/nhung-cau-chuyen-nho-dang-yeu-tai-lamluy"
                                       title="Những câu chuyện nhỏ đáng yêu tại Lamluy">Những câu chuyện nhỏ đáng yêu
                                        tại Lamluy</a>
                                </li>

                                <li class="item">
                                    <a href="/blogs/news" title="Chương trình ưu đãi">Chương trình ưu đãi</a>
                                </li>

                                <li class="item">
                                    <a href="/blogs/tips-chia-se-kinh-nghiem" title="Tips - Chia sẻ kinh nghiệm">Tips -
                                        Chia sẻ kinh nghiệm</a>
                                </li>

                                <li class="item">
                                    <a href="/blogs/vui-khoe-dep" title="Vui - Khỏe - Đẹp ♥️">Vui - Khỏe - Đẹp ♥️</a>
                                </li>
            ...
            <div class="headerSearch">
                <form action="/search" class="headerSearch">
                    ...
                    <div class="headerSearchMain">
                        ...
                        <input required="" id="headerSearchInput" name="q" maxlength="40" autocomplete="off" class="searchinput input-search search-input" type="text" size="20" placeholder="Tìm kiếm sản phẩm..." aria-label="Search">
                    </div>
                    <button type="submit" class="btn-search btn" id="headerSearchButton" aria-label="Tìm kiếm">
                    </button>
                </form>
                <div id="headerSmartSearch">
                            ...
                            <div class="subMenuTwoColumOne haveThree border-right-new">
                                ...
                                <div class="subMenuItem hasChild ">
                                    ...
                                    <ul class="subMenuThree">
                                        ...
                                        <li class="">
                                            <a href="/collections/bra-lua" title="Bralette  Lụa">
                                                Bralette  Lụa
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/bra-ren-co-ban" title="Bralette ren">
                                                Bralette ren
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/bra-thun-lanh" title="Bra thun lạnh">
                                                Bra thun lạnh
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/bra-thun-cotton" title="Bra thun cotton">
                                                Bra thun cotton
                                            </a>
                                        </li>
                                ...
                                <div class="subMenuItem hasChild ">
                                    ...
                                    <ul class="subMenuThree">
                                        ...
                                        <li class="">
                                            <a href="/collections/bra-lamluy" title="Bra Lamluy">
                                                Bra Lamluy
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/bra-nang-nguc" title="Bra nâng ngực">
                                                Bra nâng ngực
                                            </a>
                                        </li>
                            ...
                            <div class="subMenuTwoColumOne haveThree border-right-new">
                                ...
                                <div class="subMenuItem hasChild ">
                                    ...
                                    <ul class="subMenuThree">
                                        ...
                                        <li class="">
                                            <a href="/collections/quan-full-mong-khong-duong-may-day" title="Quần full mông không đường may đáy">
                                                Quần full mông không đường may đáy
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-full-mong-thun-lanh" title="Quần full mông thun lạnh">
                                                Quần full mông thun lạnh
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-full-mong-cotton" title="Quần full mông cotton">
                                                Quần full mông cotton
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-co-ban-lua" title="Quần full mông lụa">
                                                Quần full mông lụa
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-full-mong-ren" title="Quần full mông ren">
                                                Quần full mông ren
                                            </a>
                                        </li>
                                ...
                                <div class="subMenuItem hasChild ">
                                    ...
                                    <ul class="subMenuThree">
                                        ...
                                        <li class="">
                                            <a href="/collections/mua-4-tang-1-quan-day-ren" title="MUA 4 TẶNG 1- QUẦN DÂY REN">
                                                MUA 4 TẶNG 1- QUẦN DÂY REN
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-day-lua" title="Quần dây lụa">
                                                Quần dây lụa
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-day-ren-1" title="Quần dây ren">
                                                Quần dây ren
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-day-thun" title="Quần dây thun">
                                                Quần dây thun
                                            </a>
                                        </li>
                                ...
                                <div class="subMenuItem hasChild ">
                                    ...
                                    <ul class="subMenuThree">
                                        ...
                                        <li class="">
                                            <a href="/collections/quan-nua-mong" title="Quần nửa mông thun">
                                                Quần nửa mông thun
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-nua-mong-ren" title="Quần nửa mông ren">
                                                Quần nửa mông ren
                                            </a>
                                        </li>
                                ...
                                <div class="subMenuItem hasChild ">
                                    ...
                                    <ul class="subMenuThree">
                                        ...
                                        <li class="">
                                            <a href="/collections/quan-thong-ren" title="Quần lọt khe ren">
                                                Quần lọt khe ren
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-thong-lua" title="Quần lọt khe lụa">
                                                Quần lọt khe lụa
                                            </a>
                                        </li>
                                ...
                                <div class="subMenuItem hasChild ">
                                    ...
                                    <ul class="subMenuThree">
                                        ...
                                        <li class="">
                                            <a href="/collections/quan-che-bung-thun" title="Quần che bụng thun">
                                                Quần che bụng thun
                                            </a>
                                        </li>

                                        <li class="">
                                            <a href="/collections/quan-che-bung-ren" title="Quần che bụng ren">
                                                Quần che bụng ren
                                            </a>
                                        </li>
                    ...
                    <li class="active hasChild">
                        ...
                        <div class="subMenuTwo">
                            <div class="subMenuTwoColumOne noThree border-right-new">
                                ...
                                <div class="subMenuItem ">
                                    <a href="/collections/bst-canh-xuan" title="Bst Cánh Xuân">
                                        Bst Cánh Xuân
                                    </a>
                                </div>
                    ...
                    <li class=" hasChild">
                        ...
                        <div class="subMenuTwo">
                            <div class="subMenuTwoColumOne noThree border-right-new">
                                ...
                                <div class="subMenuItem ">
                                    <a href="/blogs/thoi-trang-noi-y" title="Thời trang nội y">
                                        Thời trang nội y
                                    </a>
                                </div>
