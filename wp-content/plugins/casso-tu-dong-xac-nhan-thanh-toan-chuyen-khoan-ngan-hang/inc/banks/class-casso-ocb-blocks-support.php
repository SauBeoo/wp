 ...
 * @since 3.12.1
 */
final class WC_CASSO_OCB_Blocks_Support extends AbstractPaymentMethodType {
	/**
	 * Name of the payment method.
	 *
	 * @var string
	 */
	protected $name = 'casso_up_ocb';
	protected $bank_name = 'OCB';
	...
	public function is_active() {
		...
		return $payment_gateways['casso_up_ocb']->is_available();
	}
	...
	public function get_payment_method_script_handles() {
		...
		wp_register_script(
			'wc-casso_up_ocb-blocks-integration',
			CASSO_URL . '/assets/js/ocb.js',
			$dependencies,
			$version,
			true
		);
		wp_set_script_translations(
			'wc-casso_up_ocb-blocks-integration',
			'woocommerce-gateway-casso_up_ocb'
		);
		return [ 'wc-casso_up_ocb-blocks-integration' ];
	}
	...
	public function get_payment_method_data() {
		...
		return [
			...
			'logo_url'    => CASSO_URL . '/assets/ocb.png'
		];
	}
	...
	public function get_supported_features() {
		...
		return $payment_gateways['casso_up_ocb']->supports;
	}
