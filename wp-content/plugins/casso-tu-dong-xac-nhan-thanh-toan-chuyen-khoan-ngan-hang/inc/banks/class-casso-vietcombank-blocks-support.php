 ...
 * @since 3.12.1
 */
final class WC_CASSO_Vietcombank_Blocks_Support extends AbstractPaymentMethodType {
	/**
	 * Name of the payment method.
	 *
	 * @var string
	 */
	protected $name = 'casso_up_vietcombank';
	protected $bank_name = 'Vietcombank';
	...
	public function is_active() {
		...
		return $payment_gateways['casso_up_vietcombank']->is_available();
	}
	...
	public function get_payment_method_script_handles() {
		...
		wp_register_script(
			'wc-casso_up_vietcombank-blocks-integration',
			CASSO_URL . '/assets/js/vietcombank.js',
			$dependencies,
			$version,
			true
		);
		wp_set_script_translations(
			'wc-casso_up_vietcombank-blocks-integration',
			'woocommerce-gateway-casso_up_vietcombank'
		);
		return [ 'wc-casso_up_vietcombank-blocks-integration' ];
	}
	...
	public function get_payment_method_data() {
		...
		return [
			...
			'logo_url'    => CASSO_URL . '/assets/vietcombank.png'
		];
	}
	...
	public function get_supported_features() {
		...
		return $payment_gateways['casso_up_vietcombank']->supports;
	}
